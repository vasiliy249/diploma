...
Запуск гостевой ОС включает выполнение гостевого кода, обработки таймеров, выполнение ввода/вывода и ответы на команды монитора?. Делая все эти вещи сразу требуется архитектура, способная опосредовать ресурсы безопасным способом, не останавливая работу гостевой ОС в случае, когда диск ввода/вывода или монитор команд требуют длительного времени для выполнения. Есть две популярных архитектуры программ, которые должны реагировать на события из нескольких источников:
