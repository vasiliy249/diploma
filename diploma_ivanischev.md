...
Ещё один немаловажный аспект – инвазивность исследовательских действий. Если при снятии или анализе информации память целевой системы модифицируется, то данный метод недопустим с точки зрения компьютерной криминалистики. Такие методы, в лучшем случае, можно отнести к криминалистически сомнительным, хотя, как правило, они являются криминалистически неправильными. Таким образом, вводится третья классификация имеющихся методик – по признаку инвазивности производимых действий:
