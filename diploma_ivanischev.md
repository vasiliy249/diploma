...
KVM (Kernel-based Virtual Machine) – это программное решение, обеспечивающее поддержку технологий виртуализации в ОС на базе Linux. Проект KVM зарекомендовал себя как надёжное программное обеспечение и входит в основную ветку разработки ядра Linux с 2007 г. Сам по себе KVM не выполняет эмуляции, он просто позволяет использовать аппаратную виртуализацию процессоров на уровне ядра операционной системы.
